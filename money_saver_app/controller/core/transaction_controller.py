...
class TransactionController(RouterController):
    def __init__(self, router_prefix: str, transaction_service: TransactionService) -> None:
    ...
    def register_routes(self) -> APIRouter:
        ...
        def get_all_transaction_by_user_id(user_id: int = Depends(get_current_user_id)) -> Iterable[TransactionView]:
            logger.info(user_id)
            return self.transaction_service.get_all_transaction_by_user_id(user_id)
